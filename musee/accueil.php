  ...
  <body>
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-md-6 menu2 "><a href="index.php" id="liens">Musées</a></div>
      </div>
    ...
    <div class="footer-bottom">
        <div>
            <p> Copyright Ministère de la Culture © le logo "musée de France" est une marque déposé son utilisation et sa mise à disposition est autorisée dans la limite des droits accordés par l'article L713-6 alinéa b du Code de la propriété intellectuelle et est reproduite ici en vertu de ces droits. </p>
            <p>Les droits des photos utilisé sur ce site reviennent à leur propriétaire respectif,si vous souhaitez retirer une photo vous appartenant, veuillez nous contacter et nous la retirerons immédiatement.</p>
            </div>
        </div>
    </div>
    <!--/.footer-bottom-->
