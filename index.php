...
<body>
	...
	if(isset($_GET['q']) AND !empty($_GET['q']))
	{
		...
		$donnees = $bdd->query('SELECT * FROM listemusees WHERE CONCAT(cp, ville, nom_reg, nom_dep, nom_du_musee) LIKE "%'.$q.'%"');


		if(($donnee = $donnees->fetch()) == false)
		{
			echo "Aucun résultat trouvé pour la recherche : " . $_GET['q'];
		}
		else
		{
			do
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                                    ...
                                    <strong>Site Web</strong> : <?php echo "<a href='http://".$web."'target='_blank'>$web</a>" ?><br />
