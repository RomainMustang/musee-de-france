...
<body id="bghome">
  <div class="col-md-12">
    <div class="row">
      <div class="col-md-6 menu1 "><a href="#" class="links">Accueil</a></div>
      <div class="col-md-6 menu2 "><a href="recherche.php" class="links">Musées</a></div>
    </div>
  ...
  <footer>
    <div class="footer" id="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3  col-md-3 col-sm-5 col-sm-offset-1 col-xs-6 ">
            <h3><a class="linksf" href="mailto:sarah.p@codeur.online"> Py Sarah </a></h3>
            <ul>
              <li> <a class="linksf" href="https://twitter.com/SarahConnor700"> <i class="fa fa-twitter">   </i> </a> </li>
            </ul>
          </div>
          <div class="col-lg-3  col-md-3 col-sm-5 col-sm-offset-1 col-xs-6">
            <h3><a class="linksf" href="mailto:vincent.g@codeur.online"> Gerard Vincent </a></h3>
            <ul>
              <li> <a class="linksf" href="https://twitter.com/VincentTime0"> <i class="fa fa-twitter">   </i> </a> </li>

            </ul>
          </div>
          <div class="col-lg-3  col-md-3 col-sm-5 col-sm-offset-1 col-xs-6">
            <h3><a class="linksf" href="mailto:romain.g@codeur.online"> Grandjean Romain </a></h3>
            <ul>
              <li> <a class="linksf" href="https://twitter.com/RomainMustang"> <i class="fa fa-twitter">   </i> </a> </li>

            </ul>
          </div>
          <div class="col-lg-3  col-md-3 col-sm-5 col-sm-offset-1 col-xs-6">
            <h3><a class="linksf" href="mailto:kevin.b@codeur.online"> Bourlier Kevin </a></h3>
            <ul>
              <li> <a class="linksf" href="https://twitter.com/dantikevin"> <i class="fa fa-twitter">   </i> </a> </li>
            </ul>
          </div>
        </div>
        <!--/.row-->
